...
4. Tabelas como "Próximos Passos Recomendados" so podem citar skills que voce CONFIRMOU que existem (listar `.claude/skills/` antes). Nunca inventar nome de skill.
...
## Upload pro MinIO (NOVO 2026-05-05 — entrega via drive)
...
1. **Decida o slug** do projeto/persona: nome em formato slug (lowercase, sem acento, hifens). Ex: "Persona Marcao Acelera IA" -> `marcao-acelera-ia`.
...
5. O script imprime no **stdout** o link do console MinIO. Padrao: `seu-bucket/personas/YYYY-MM-DD-<slug>/`.
